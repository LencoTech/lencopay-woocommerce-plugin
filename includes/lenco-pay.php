                ...
                function initiateLencoPayment() {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            billing_company: $('input#billing_company').val(),
                            ...
                            billing_state: $('select#billing_state, input#billing_state').val(),
                            billing_postcode: $('input#billing_postcode').val(),
                            ...
                            shipping_company: $('input#shipping_company').val(),
                            ...
                            shipping_state: $('select#shipping_state, input#shipping_state').val(),
                            shipping_postcode: $('input#shipping_postcode').val(),
                            shipping_country: $('select#shipping_country').val(),
                            // Order details
